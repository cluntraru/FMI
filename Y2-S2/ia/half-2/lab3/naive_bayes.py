...
train_images = np.loadtxt('../data0/train_images.txt')
train_labels = np.loadtxt('../data0/train_labels.txt', 'int')
test_images = np.loadtxt('../data0/test_images.txt')
test_labels = np.loadtxt('../data0/test_labels.txt', 'int')
