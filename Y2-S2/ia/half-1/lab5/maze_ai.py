...
class Graf:
    ...
    def calculeaza_h(self, reprez_nod):
        pozitie_unu_reprez_nod = reprez_nod.index(1)
        pozitie_unu_scop_nod = self.reprez_scop.index(1)
        i_nod = pozitie_unu_reprez_nod // 20
        j_nod = pozitie_unu_reprez_nod % 20
        i_scop = pozitie_unu_scop_nod // 20
        j_scop = pozitie_unu_scop_nod % 20
    ...
    def calculeaza_succesori(self, nod):
        # determina j si j pentru 1 in nod.info
        if i <=18:
            # det noul i si j pentru 1 daca se face o mutare in jos
            # det daca se poate face mutarea, nod.info la poz noua != 2
            # fac interschimbare
            # creati nod nou
            pass
        if i >=1:
