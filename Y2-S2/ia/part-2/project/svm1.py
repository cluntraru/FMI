...
data_path = ""
train_labels = np.genfromtxt(data_path + "train_labels02.csv", delimiter = ",")
train_labels = train_labels[:,1]

# Citim datele de test si de antrenare
train_data, train_ids = data_from_dir(data_path, "train02/")
test_data, test_ids = data_from_dir(data_path, "train1/")
...
out_file_name = data_path + "output1.csv"
